...
+ (NSDateFormatter * _Nonnull)default SWIFT_WARN_UNUSED_RESULT;
@end
...
///   </li>
/// </ul>
- (NSArray<NSRelationshipDescription *> * _Nonnull)sync_relationships SWIFT_WARN_UNUSED_RESULT;
/// Finds the attributes for the current entity.
///
/// returns:
/// An array of attributes for the current entity.
- (NSArray<NSAttributeDescription *> * _Nonnull)sync_attributes SWIFT_WARN_UNUSED_RESULT;
...
///   </li>
/// </ul>
- (NSRelationshipDescription * _Nullable)sync_parentEntity SWIFT_WARN_UNUSED_RESULT;
@end
...
- (NSManagedObject * _Nonnull)sync_copyInContext:(NSManagedObjectContext * _Nonnull)context SWIFT_WARN_UNUSED_RESULT;
